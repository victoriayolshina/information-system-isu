...
VALUES (1, 'Прикладная Информатика', '09.03.03'),
...
INSERT INTO `faculty` (`id`, `name`, `direction`, `year`)
VALUES (1, '2461', 1, 2017),
       (2, '2471', 2, 2018),
...
INSERT INTO `practice` (`id`, `student`, `starttime`, `endtime`, `post`)
VALUES (1, 1, '2021-02-07', '2021-03-20', 'Практикант');
...
INSERT INTO `student` (`id`, `surname`, `name`, `patronymic`, `faculty`, `username`)
VALUES (1, 'Ёлшина', 'Виктория', 'Евгеньевна', 1, 'yolshina2017'),
...
INSERT INTO `tasks` (`id`, `datastart`, `dataend`, `task`, `description`, `practice`)
VALUES (1, '2021-02-24', '2021-02-28', 'Заполнение дневника практики.', 'По инструкции ручками заполнили дневник.', 1),
